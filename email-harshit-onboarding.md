...
- **Anthropic / Claude** — You've been set up with a company account (harshit@consultantbot.bar). Use this to log into Claude for Claude Code access — it's our recommended dev workflow.
